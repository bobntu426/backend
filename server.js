  ...
  server.start({ port: PORT }, async() => {
    ...
    if(people.length == 0){
      await People.insertMany([
        ...
        {name:'黃鈺蓁',score:850,school:'台灣大學',id:43,popular:15,gender:'female',rank:13},
    ...
    if(double.length == 0){
      await Double.insertMany([
        ...
        {player:[1,43],score:1200,school:'台灣大學',id:9,gender:'mix',rank:1},
        {player:[3,44],score:1000,school:'輔仁大學',id:10,gender:'mix',rank:2}
      ])
